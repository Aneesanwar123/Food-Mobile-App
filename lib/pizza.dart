...
class _pizzaState extends State<pizza> {
  ...
  int get totalamount => quantity * pizzaprice;
                            ...
                            Padding(
                              ...
                              child: Center(
                                child: Container(
                                  ...
                                  child: Image.asset("images/pep.png"),
                                ),
                              ),
                            ),
                          ],
                                        ...
                                        Container(
                                          ...
                                          child: IconButton(
                                            onPressed: () {
                                              ...
                                              // call a fucntion which we create for a updating quantity according to the user cart tapping
                                              increamentquantity();
                                            },
                                            icon: Icon(
                                              CupertinoIcons.add,
